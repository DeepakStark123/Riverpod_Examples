...
class FavouriteNotifier extends StateNotifier<FavouriteState> {
  ...
  void filterList(String search) {
    state = state.copyWith(
        filteredItems: _filterItems(state.allItems, search), search: search);
  }

  void favouriteItem(String option) {
    state =
        state.copyWith(filteredItems: _favouriteItem(state.allItems, option));
  }
...
class FavouriteState {
  ...
  FavouriteState copyWith(
      {List<Item>? allItems, String? search, List<Item>? filteredItems}) {
